    ...
    <div class="crud-modal-card">
        ...
        <div class="crud-modal-body settings-modal-body">
            ...
            <section class="crud-panel settings-panel" data-settings-panel="companies" hidden>
                ...
                <div class="settings-create-row shift-wizard" data-company-create-row>
                    <div class="shift-wizard-steps">

                        <section class="shift-wizard-step is-active" data-cw-step="1">
                            <button type="button" class="shift-wizard-step-head" data-cw-step-toggle>
                                <span class="shift-wizard-step-num">1</span>
                                <span class="shift-wizard-step-title">Nome, tipo e logo</span>
                                <span class="shift-wizard-step-summary" data-cw-step-summary="1"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-cw-step-body>
                                ...
                                <button type="button" class="admin-action-link" data-cw-next="2">Avanti</button>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-cw-step="2">
                            <button type="button" class="shift-wizard-step-head" data-cw-step-toggle>
                                <span class="shift-wizard-step-num">2</span>
                                <span class="shift-wizard-step-title">Indirizzo</span>
                                <span class="shift-wizard-step-summary" data-cw-step-summary="2"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-cw-step-body hidden>
                                ...
                                <div class="shift-wizard-step-actions">
                                    <button type="button" class="admin-action-link admin-action-link-secondary" data-cw-back="1">Indietro</button>
                                    <button type="button" class="admin-action-link" data-cw-next="3">Avanti</button>
                                </div>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-cw-step="3">
                            <button type="button" class="shift-wizard-step-head" data-cw-step-toggle>
                                <span class="shift-wizard-step-num">3</span>
                                <span class="shift-wizard-step-title">Contatti</span>
                                <span class="shift-wizard-step-summary" data-cw-step-summary="3"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-cw-step-body hidden>
                        ...
                        <section class="shift-wizard-step" data-cw-step="4">
                            <button type="button" class="shift-wizard-step-head" data-cw-step-toggle>
                                <span class="shift-wizard-step-num">4</span>
                                <span class="shift-wizard-step-title">Rete Wi-Fi autorizzata (facoltativo)</span>
                                <span class="shift-wizard-step-summary" data-cw-step-summary="4"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-cw-step-body hidden>
                                <label class="settings-field"><?php echo e(t('settings.authorized_wifi_ip')); ?><input data-field="signature_ip" type="text" value=""></label>
                                <div class="shift-wizard-step-actions">
                                    <button type="button" class="admin-action-link admin-action-link-secondary" data-cw-back="3">Indietro</button>
            ...
            <section class="crud-panel settings-panel" data-settings-panel="assignment-planner" hidden>
                ...
                <div class="settings-create-row shift-wizard" data-planning-wizard>
                    <div class="shift-wizard-steps">

                        <section class="shift-wizard-step is-active" data-pw-step="1">
                            <button type="button" class="shift-wizard-step-head" data-pw-step-toggle>
                                <span class="shift-wizard-step-num">1</span>
                                <span class="shift-wizard-step-title">Periodo e reparto</span>
                                <span class="shift-wizard-step-summary" data-pw-step-summary="1"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-pw-step-body>
                                <label class="settings-field"><?php echo e(t('common.department')); ?>
                                    <select data-pw-department>
                                ...
                                <label class="settings-field"><?php echo e(t('settings.from_date')); ?>
                                    <input data-pw-range-start type="date" value="<?php echo e($currentMonthStart); ?>" min="<?php echo e($currentMonthStart); ?>">
                                </label>
                                <label class="settings-field"><?php echo e(t('settings.to_date')); ?>
                                    <input data-pw-range-end type="date" value="<?php echo e($currentMonthEnd); ?>" min="<?php echo e($currentMonthStart); ?>">
                                </label>
                                <button type="button" class="admin-action-link" data-pw-next="2">Avanti</button>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-pw-step="2">
                            <button type="button" class="shift-wizard-step-head" data-pw-step-toggle>
                                <span class="shift-wizard-step-num">2</span>
                                <span class="shift-wizard-step-title">Turni da assegnare in questo periodo</span>
                                <span class="shift-wizard-step-summary" data-pw-step-summary="2"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-pw-step-body hidden>
                                <div class="settings-assignment-open-shift-list" data-pw-shift-list></div>
                                <button type="button" class="admin-action-link admin-action-link-secondary" data-pw-check-coverage>Controlla copertura periodo</button>
                                <div data-pw-coverage-report></div>
                                <div class="shift-wizard-step-actions">
                                    <button type="button" class="admin-action-link admin-action-link-secondary" data-pw-back="1">Indietro</button>
                                    <button type="button" class="admin-action-link" data-pw-next="3">Avanti</button>
                                </div>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-pw-step="3">
                            <button type="button" class="shift-wizard-step-head" data-pw-step-toggle>
                                <span class="shift-wizard-step-num">3</span>
                                <span class="shift-wizard-step-title">Dipendenti e preferenze di questa pianificazione</span>
                                <span class="shift-wizard-step-summary" data-pw-step-summary="3"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-pw-step-body hidden>
                                <p class="crud-modal-subtitle">Includi i dipendenti da assegnare e, per ciascuno, deseleziona i giorni in cui deve riposare in questo periodo (tutti i giorni sono lavorativi di default).</p>
                                <div class="shift-planning-employee-list" data-pw-employee-list>
                                    <?php foreach ($visibleUsers as $userOption): ?>
                                        <?php
                                            $plannerUserId = (int) ($userOption['id'] ?? 0);
                                            if ($plannerUserId <= 0 || (($userOption['role'] ?? '') === 'super_admin')) {
                                                continue;
                                            }
                                        ...
                                        ?>
                                        <div class="shift-planning-employee-row" data-pw-employee-row data-department-id="<?php echo (int) ($userOption['department_id'] ?? 0); ?>" hidden>
                                            <label class="settings-assignment-open-shift-chip">
                                                <input type="checkbox" data-pw-employee-include data-employee-id="<?php echo $plannerUserId; ?>" data-employee-name="<?php echo e($plannerUserName); ?>">
                                                <span><?php echo e($plannerUserName); ?></span>
                                            </label>
                                            <div class="shift-weekday-chips" data-pw-workday-chips></div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                                <div class="shift-wizard-step-actions">
                                    <button type="button" class="admin-action-link admin-action-link-secondary" data-pw-back="2">Indietro</button>
                                    <button type="button" class="admin-action-link" data-pw-next="4">Avanti</button>
                                </div>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-pw-step="4">
                            <button type="button" class="shift-wizard-step-head" data-pw-step-toggle>
                                <span class="shift-wizard-step-num">4</span>
                                <span class="shift-wizard-step-title">Assegnazione automatica</span>
                                <span class="shift-wizard-step-summary" data-pw-step-summary="4"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-pw-step-body hidden>
                                <div class="shift-wizard-step-actions">
                                    <button type="button" class="admin-action-link admin-action-link-secondary" data-pw-back="3">Indietro</button>
                                    <button type="button" class="admin-action-link" data-pw-run>Assegna automaticamente turni periodo</button>
                                </div>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-pw-step="5">
                            <button type="button" class="shift-wizard-step-head" data-pw-step-toggle>
                                <span class="shift-wizard-step-num">5</span>
                                <span class="shift-wizard-step-title">Risultato e approvazione manuale</span>
                                <span class="shift-wizard-step-summary" data-pw-step-summary="5"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-pw-step-body hidden>
                                <div data-pw-result></div>
                                <p class="crud-modal-subtitle">Le assegnazioni sono già salvate. Per approvarle o modificarle manualmente, apri il Calendario dalla dashboard: potrai trascinare o correggere ogni turno come di consueto.</p>
                            </div>
                        </section>
            ...
            <section class="crud-panel settings-panel" data-settings-panel="departments" hidden>
                ...
                <?php if ($canCreateDepartments): ?>
                    <div class="settings-create-row shift-wizard" data-dept-create-row>
                        <div class="shift-wizard-steps">

                            <section class="shift-wizard-step is-active" data-dw-step="1">
                                <button type="button" class="shift-wizard-step-head" data-dw-step-toggle>
                                    <span class="shift-wizard-step-num">1</span>
                                    <span class="shift-wizard-step-title">Nome, icona e colore</span>
                                    <span class="shift-wizard-step-summary" data-dw-step-summary="1"></span>
                                </button>
                                <div class="shift-wizard-step-body" data-dw-step-body>
                                    <label class="settings-field"><?php echo e(t('settings.name_label')); ?><input data-field="name" type="text" value=""></label>
                                    ...
                                    <button type="button" class="admin-action-link" data-dw-next="2">Avanti</button>
                                </div>
                            </section>

                            <section class="shift-wizard-step" data-dw-step="2">
                                <button type="button" class="shift-wizard-step-head" data-dw-step-toggle>
                                    <span class="shift-wizard-step-num">2</span>
                                    <span class="shift-wizard-step-title">Capo reparto (facoltativo)</span>
                                    <span class="shift-wizard-step-summary" data-dw-step-summary="2"></span>
                                </button>
                                <div class="shift-wizard-step-body" data-dw-step-body hidden>
                                    ...
                                    <div class="shift-wizard-step-actions">
                                        <button type="button" class="admin-action-link admin-action-link-secondary" data-dw-back="1">Indietro</button>
            ...
            <section class="crud-panel settings-panel" data-settings-panel="users" hidden>
                ...
                <div class="settings-list-head settings-create-row" data-user-create-row>
                    <div class="settings-list-cols settings-list-cols-user-create">
                        ...
                        <label class="settings-field settings-field-span-2"><?php echo e(t('crud.password')); ?>
            ...
            <section class="crud-panel settings-panel" data-settings-panel="shifts" hidden>
                ...
                <div class="settings-create-row settings-create-row-shift shift-wizard" data-shift-create-row>
                    <div class="shift-wizard-steps">

                        <section class="shift-wizard-step is-active" data-wizard-step="1">
                            <button type="button" class="shift-wizard-step-head" data-wizard-step-toggle="1">
                                <span class="shift-wizard-step-num">1</span>
                                <span class="shift-wizard-step-title"><?php echo e(t('settings.shift_wizard_step1', ['fallback' => 'Nome, logo e colore'])); ?></span>
                                <span class="shift-wizard-step-summary" data-wizard-step-summary="1"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-wizard-step-body="1">
                                <label class="settings-field"><?php echo e(t('common.department')); ?>
                                ...
                                <label class="settings-field"><?php echo e(t('settings.name_label')); ?><input data-field="name" type="text" value="" placeholder="<?php echo e(t('settings.shift_name_placeholder')); ?>"></label>
                                <?php if ($currentRole === 'super_admin'): ?>
                                    <label class="settings-field"><?php echo e(t('crud.role')); ?>
                                ...
                                <button type="button" class="admin-action-link shift-wizard-next" data-wizard-next="2"><?php echo e(t('common.next', ['fallback' => 'Avanti'])); ?></button>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-wizard-step="2">
                            <button type="button" class="shift-wizard-step-head" data-wizard-step-toggle="2">
                                <span class="shift-wizard-step-num">2</span>
                                <span class="shift-wizard-step-title"><?php echo e(t('settings.shift_wizard_step2', ['fallback' => 'Giorni della settimana'])); ?></span>
                                <span class="shift-wizard-step-summary" data-wizard-step-summary="2"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-wizard-step-body="2" hidden>
                                <div class="shift-weekday-chips">
                                    <?php foreach ($weekdayLabels as $weekdayValue => $weekdayLabel): ?>
                                        <button type="button" class="shift-weekday-chip is-selected" data-weekday-chip data-weekday-value="<?php echo (int) $weekdayValue; ?>"><?php echo e($weekdayLabel); ?></button>
                                    <?php endforeach; ?>
                                </div>
                                <select data-field="work_weekdays" multiple class="shift-wizard-hidden-select" hidden>
                                    <?php foreach ($weekdayLabels as $weekdayValue => $weekdayLabel): ?>
                                        <option value="<?php echo (int) $weekdayValue; ?>" selected><?php echo e($weekdayLabel); ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div class="shift-wizard-step-actions">
                                    <button type="button" class="admin-action-link admin-action-link-secondary" data-wizard-back="1"><?php echo e(t('common.back', ['fallback' => 'Indietro'])); ?></button>
                                    <button type="button" class="admin-action-link shift-wizard-next" data-wizard-next="3"><?php echo e(t('common.next', ['fallback' => 'Avanti'])); ?></button>
                                </div>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-wizard-step="3">
                            <button type="button" class="shift-wizard-step-head" data-wizard-step-toggle="3">
                                <span class="shift-wizard-step-num">3</span>
                                <span class="shift-wizard-step-title"><?php echo e(t('settings.shift_wizard_step3', ['fallback' => 'Orario'])); ?></span>
                                <span class="shift-wizard-step-summary" data-wizard-step-summary="3"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-wizard-step-body="3" hidden>
                                ...
                                <div class="shift-wizard-step-actions">
                                    <button type="button" class="admin-action-link admin-action-link-secondary" data-wizard-back="2"><?php echo e(t('common.back', ['fallback' => 'Indietro'])); ?></button>
                                    <button type="button" class="admin-action-link shift-wizard-next" data-wizard-next="4"><?php echo e(t('common.next', ['fallback' => 'Avanti'])); ?></button>
                                </div>
                            </div>
                        </section>

                        <section class="shift-wizard-step" data-wizard-step="4">
                            <button type="button" class="shift-wizard-step-head" data-wizard-step-toggle="4">
                                <span class="shift-wizard-step-num">4</span>
                                <span class="shift-wizard-step-title"><?php echo e(t('settings.shift_wizard_step4', ['fallback' => 'Riposi fissi e descrizione (facoltativo)'])); ?></span>
                                <span class="shift-wizard-step-summary" data-wizard-step-summary="4"></span>
                            </button>
                            <div class="shift-wizard-step-body" data-wizard-step-body="4" hidden>
                                <div class="shift-weekday-chips">
                                    <?php foreach ($weekdayLabels as $weekdayValue => $weekdayLabel): ?>
                                        <button type="button" class="shift-weekday-chip" data-restday-chip data-weekday-value="<?php echo (int) $weekdayValue; ?>"><?php echo e($weekdayLabel); ?></button>
                                    <?php endforeach; ?>
                                </div>
                                <select data-field="weekly_rest_weekdays" multiple class="shift-wizard-hidden-select" hidden>
                                    <?php foreach ($weekdayLabels as $weekdayValue => $weekdayLabel): ?>
                                ...
                                <div class="shift-wizard-step-actions">
                                    <button type="button" class="admin-action-link admin-action-link-secondary" data-wizard-back="3"><?php echo e(t('common.back', ['fallback' => 'Indietro'])); ?></button>
                    ...
                    <select data-field="month_numbers" multiple class="shift-wizard-hidden-select" hidden>
